...
public class LearningPlanPageVO<L> extends PageDTO<LearningPlanVO> {
    ...
    public LearningPlanPageVO<L> pageInfo(Long total, Long pages, List<LearningPlanVO> list) {
        this.total = total;
        this.pages = pages;
        this.list = list;
        return this;
    ...
    public LearningPlanPageVO<L> pageInfo(PageDTO<LearningPlanVO> pageDTO) {
